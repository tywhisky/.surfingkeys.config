const e="font-size: 13pt; font-family: 'JetBrains Mono NL', 'Cascadia Code', 'Helvetica Neue', Helvetica, Arial, sans-serif; border: 0px; color: #e0def4 !important; background: #191724; background-color: #191724";api.Hints.style(e);api.Hints.style(e,"text");api.Hints.style("border: solid 2px #282C34; color:#98be65; background: initial; background-color: #2E3440;");api.Hints.style("border: solid 2px #282C34 !important; padding: 1px !important; color: #51AFEF !important; background: #2E3440 !important;","text");api.Visual.style("marks","background-color: #98be6599;");api.Visual.style("cursor","background-color: #51AFEF;");const t=`
